    ...
    return (
        <div className="input-container">
            ...
            <div className="input-col-two mg-btm-20">
                <div className="input-planned-amt"><input type="text" className="input-box-small align-right" placeholder="0" onChange={e => props.plannedAmtChange(e, props.index)} /></div>
